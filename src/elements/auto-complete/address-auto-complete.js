...
/** @typedef {import('types').HttpClientFactory} HttpClientFactory */
/** @typedef {import('types').BanAddress} BanAddress */
/** @template T @typedef {import('types').FromObjectStatic<T>} FromObjectStatic */
...
export class AddressAutoComplete {
  ...
  async searchAdresse(query, type, limit, postcode, cityCode) {
    ...
    return result.features.map(feature => {
      ...
      return /** @type {FromObjectStatic<Adresse>} */ (Adresse).fromObject({
        banId: banAddress.id,
